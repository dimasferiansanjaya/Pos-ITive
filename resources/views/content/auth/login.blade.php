    ...
    <div class="auth-wrapper auth-cover">
        <div class="auth-inner row m-0">
            ...
            <a class="brand-logo" href="#">
                ...
                <h2 class="brand-text text-primary ms-1">Pos-ITive</h2>
            </a>
            <!-- /Brand logo-->
            ...
            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                    <h2 class="card-title fw-bold mb-1">Welcome to Pos-ITive! 👋</h2>
                    ...
                    <form class="auth-login-form mt-1" action="{{ route('login') }}" method="POST">
                        ...
                        <div class="mb-1">
                            ...
                            <input class="form-control @error('email') error @enderror" id="email" type="text" name="email"
