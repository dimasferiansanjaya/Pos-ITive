                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="demo-inline-spacing">
                            ...
                            <button type="button" class="btn btn-icon btn-icon rounded-circle btn-outline-primary"
                                disabled>
                                <i data-feather="search"></i>
                            </button>
                        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">
                            Group a series of buttons together on a single line with the button group. Wrap a series of
                            buttons with
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" class="btn btn-outline-primary"><i
                                            data-feather="facebook"></i></button>
                                    <button type="button" class="btn btn-outline-primary"><i
                                            data-feather="twitter"></i></button>
                                    <button type="button" class="btn btn-outline-primary"><i
                                            data-feather="instagram"></i></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-sm-12 mb-1 mb-md-0">
                                <p class="card-text mb-0">
                                    Add <code>.btn-lg</code> or <code>.btn-sm</code> for Fancy larger or smaller buttons
                                    size.
                                </p>
                                <!-- simple sizes -->
                                <div class="demo-inline-spacing">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <p class="card-text mb-0">
                                    Add <code>.btn-lg</code> or <code>.btn-sm</code> with <code>.btn-outline-*</code> for
                                    outline btn in
                                    different sizes
                                </p>
                                <div class="demo-inline-spacing">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p class="card-text">Create block level buttons with a mix of our display and gap utilities.
                        </p>
                        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text mb-0">
                            The <code>.btn</code> classes are designed to be used with the <code>&lt;button&gt;</code>
                            element. However,
